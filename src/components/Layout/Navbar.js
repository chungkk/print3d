...
export default function Navbar() {
  ...
  return (
    <div className='bg-black h-20 pl-4 md:px-12 rounded-2xl text-white flex justify-between items-center animate-scaleUp'>
      <Link href='/' className='text-white text-xl font-bold'>Sách Ơi! BookShelves</Link>
